REPORT AFTER MULTIPLE SEQUENCE ALIGNMENT (CLUSTAL OMEGA)
...
OUR QUERY PROTEIN: NP_001122316.1 SWI/SNF-related matrix-associated actin-dependent regulator of chromatin subfamily A member 4 isoform B [Homo sapiens]  
The sequence consisted of 1647 amino acids.
Similarly, the protein sequence of yeast SNF2 was retrieved from the NCBI Protein database after it was identified through BLAST analysis. The SNF2 protein sequence contained 1703 amino acids.
...
BLASTp compares the query sequence with sequences in the database and identifies regions of similarity called High-scoring Segment Pairs (HSPs). The protein sequence at the top was analysed as it showed highest compatibility. Our sequence being:
OUR SBJCT PROTEIN: NP_014933.3 SWI/SNF catalytic subunit SNF2 [Saccharomyces cerevisiae S288C]
Results obtained:
Query coverage: 54%
Range 1 identity: 52%
Range 2 identity: 30%
...
In the Clustal Omega output, the symbol “*” indicates identical amino acids, “:” indicates amino acids with strongly similar chemical properties, and “.” indicates weak similarity. Regions without symbols represent positions where amino acids differ significantly.
Analysis of the alignment revealed a highly conserved central region between SMARCA4 and SNF2, particularly corresponding to the ATPase helicase core. This region showed long stretches of identical amino acids marked by “*”, indicating strong sequence conservation. For example, conserved motifs involved in ATP binding and hydrolysis, including glycine-rich and lysine-containing sequences characteristic of ATP-binding proteins, were present in both SMARCA4 and SNF2.

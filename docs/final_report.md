...
In the phylogram, the numerical values associated with each branch represent evolutionary distances, measured as the number of amino acid substitutions per site that have accumulated during evolution. Smaller values therefore indicate highly conserved sequences with very few substitutions, while larger values indicate greater sequence divergence.
The SMARCA4 proteins from mammals clustered tightly together. In particular, the homologs from human, mouse, and rat displayed extremely small evolutionary distances, with values approaching 0.00000 substitutions per site. This does not mean that the sequences are completely identical; rather, the differences between them are so small that they fall below the resolution of the simple distance model used for tree construction and are rounded to zero in the output. This observation reflects the relatively recent evolutionary divergence of rodent and primate lineages approximately 90-100 million years ago, and indicates strong conservation of the SMARCA4 protein within mammals.

The avian homologs from chicken and blue tit also appeared within the broader vertebrate branch but showed slightly larger evolutionary distances compared to mammals. This pattern is consistent with the divergence between bird and mammalian lineages approximately 300 million years ago. Amphibian and fish homologs exhibited even larger branch lengths, corresponding to the earlier diversification of vertebrate lineages roughly 400-500 million years ago.
In contrast, the invertebrate homologs from Drosophila melanogaster and Caenorhabditis elegans showed substantially greater evolutionary distances relative to vertebrate sequences. These organisms belong to lineages that diverged from vertebrates approximately 600-700 million years ago, which explains the larger sequence differences observed in their SNF2-family proteins.

The fungal SNF2 protein from Saccharomyces cerevisiae formed the most distant branch of the tree, with an evolutionary distance of approximately 0.339 substitutions per site, indicating the greatest degree of sequence divergence among the organisms analysed. This large evolutionary distance reflects the very ancient separation of fungi from the lineage that eventually gave rise to animals, which occurred more than one billion years ago.
Despite these enormous evolutionary timescales and the vast biological diversity represented in the analysis from unicellular fungi to complex vertebrates, the core SNF2 ATPase domain remains strongly conserved across all species. This conservation strongly suggests that the SNF2 chromatin-remodelling ATPase originated in an early eukaryotic ancestor before the major diversification of modern eukaryotic lineages. As evolution progressed and organisms became more complex, this ancestral protein was inherited and modified, allowing species to adapt chromatin-remodelling mechanisms to their own regulatory requirements.

The persistence of the SNF2 catalytic core across such diverse organisms illustrates a fundamental principle of molecular evolution: while organisms evolve and diversify over geological time, essential molecular mechanisms tend to be preserved because they perform indispensable cellular functions. Chromatin remodelling is one such fundamental process. By regulating access to DNA, SNF2-family proteins control transcription, replication, and DNA repair, processes that are crucial for maintaining genome stability and proper cellular function.

Viewed in this way, the phylogenetic tree represents more than a computational reconstruction of sequence similarity. It provides insight into the deep evolutionary history of a critical molecular system. Over the course of more than one billion years of evolution, from the earliest eukaryotic cells to modern multicellular organisms, the SNF2 chromatin-remodelling machinery has remained a central component of genome regulation. Evolution has diversified the organisms that carry this protein, yet the fundamental molecular engine responsible for regulating chromatin structure has remained remarkably conserved, underscoring its essential role in the biology of life.
